...
import com.example.myjetsurvey.util.supportWideScreen
        ...
        Scaffold(
            content = { innerPadding ->
                ...
                SurveyResult(
                    ...
                    description = stringResource(id = R.string.thank_you),
                    modifier = modifier
                )
            },
            bottomBar = {
...
private fun TopAppBarTitle(
    questionIndex: Int, totalQuestionsCount: Int, modifier: Modifier = Modifier
) {
...
@Composable
fun SurveyTopAppBar(
    questionIndex: Int, totalQuestionsCount: Int, onClosePressed: () -> Unit
) {
    Column(
        ...
        CenterAlignedTopAppBar(title = {
            TopAppBarTitle(
                questionIndex = questionIndex, totalQuestionsCount = totalQuestionsCount
            )
        }, actions = {
        ...
        Row(
            ...
            if (shouldShowPreviousButton) {
                OutlinedButton(
                    modifier = Modifier
                        .weight(1f)
                        .height(48.dp), onClick = onPreviousPressed
                ) {
